...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h008431b126461144: (a: number, b: number) => void;
export const closure153_externref_shim: (a: number, b: number, c: any) => void;
export const closure850_externref_shim: (a: number, b: number, c: any) => number;
export const closure756_externref_shim: (a: number, b: number, c: any, d: any) => void;
