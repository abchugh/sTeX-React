...
const SectionWrap: React.FC<{uri:string,children:ReactNode}> = ({uri,children}) => {
  return <div style={{border:"1px solid red",margin:"1em 0",width:"100%"}}>
...
export const TestFragmentA = () => {
  return <>
    <p>Multiple Choice:</p>
    <FTMLFragment fragment={{uri:"https://stexmmt.mathhub.info/:sTeX?a=sTeX/DemoExamples&d=problemtest&l=en&e=exercise_1"}}/>
  </>
}
...
export const TestFragmentB = () => {
  return <>
    ...
    <FTMLFragment 
      fragment={{uri:"https://stexmmt.mathhub.info/:sTeX?a=sTeX/DemoExamples&d=problemtest&l=en&e=exercise_3"}}
