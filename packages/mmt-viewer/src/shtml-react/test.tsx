...
import { SHTMLDocument, SHTMLFragment } from "./documents";
...
export const TestFragmentA = () => {
  return <>
    <p>Multiple Choice:</p>
    <SHTMLFragment opt={{uri:"https://stexmmt.mathhub.info/:sTeX?a=sTeX/DemoExamples&d=problemtest&l=en&e=exercise_1"}}/>
  </>
}
