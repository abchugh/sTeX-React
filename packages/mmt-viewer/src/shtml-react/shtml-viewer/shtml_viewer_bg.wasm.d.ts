...
export const shtml_setup: (a: any, b: any) => number;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha9487991452276c6: (a: number, b: number) => void;
export const closure253_externref_shim: (a: number, b: number, c: any) => void;
export const closure816_externref_shim: (a: number, b: number, c: any) => number;
